...
## Objetivo
Diseñar el esquema de base de datos utilizando DDL en SQLite, aplicando tipos de datos adecuados, constraints (NOT NULL, DEFAULT, UNIQUE, CHECK), relaciones entre tablas y un script idempotente que pueda ejecutarse varias veces sin errores.
