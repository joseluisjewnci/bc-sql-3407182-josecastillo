    ...
    --parts 
    INSERT INTO parts (name, price, stock) VALUES ('Llanta',50000, 25 );
    INSERT INTO parts (name, price, stock) VALUES ('Cadena', 20000, 20);
    INSERT INTO parts (name, price, stock) VALUES ('Frenos', 85000,27);
    INSERT INTO parts (name, price, stock) VALUES ('Pedales', 150000, 12);
    INSERT INTO parts (name, price, stock) VALUES ('Manubrios', 16000, 30);
    ...
    --repairs
    INSERT INTO repairs (bike_id, description, cost, date) VALUES (1,'Cambio de llanta', 50000, '2026-04-13');
    INSERT INTO repairs (bike_id, description, cost, date) VALUES (2,'Cambio de cadena', 35000, '2026-04-13');
    INSERT INTO repairs (bike_id, description, cost, date) VALUES (3,'Cambio de frenos', 30000, '2026-04-15');
    INSERT INTO repairs (bike_id, description, cost, date) VALUES (4,'Cambio de pedales', 25000, '2026-04-17');
    INSERT INTO repairs (bike_id, description, cost, date) VALUES (5,'Mantenimiento general', 65000, '2026-04-19');
